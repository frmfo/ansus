...
class CostcentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create costcenter" do
    assert_difference("Costcenter.count") do
      post costcenters_url, params: { costcenter: { branch_id: @costcenter.branch_id, name: @costcenter.name, service_id: @costcenter.service_id, status: @costcenter.status } }
    end
  ...
  test "should update costcenter" do
    patch costcenter_url(@costcenter), params: { costcenter: { branch_id: @costcenter.branch_id, name: @costcenter.name, service_id: @costcenter.service_id, status: @costcenter.status } }
